...
============================
    rpm -ivh https://hpc.lenovo.com/yum/20a/el8/x86_64/lenovo-hpc-yum-el8-19.12-20a.x86_64.rpm
...
============================
    zypper install http://hpc.lenovo.com/yum/20a/suse15/x86_64/lenovo-hpc-zypper-suse15-19.12-20a.x86_64.rpm
...
The files are located at [https://hpc.lenovo.com/downloads/20a]( https://hpc.lenovo.com/downloads/20a "https://hpc.lenovo.com/downloads/20a" ):
    ...
    wget https://hpc.lenovo.com/downloads/20a/xcat-<xcat version>.lenovo_confluent-<confluent version>-<osver>.tar.bz2
