...
given its BMC's address as the host address during a deployment.
...
This provides the secret protection to a class of custom attributes, available to a node during deployment by using its token.  This can be used as a vault to hold credentials
