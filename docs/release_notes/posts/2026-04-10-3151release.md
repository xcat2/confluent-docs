...
An inscrutable error appeared for users trying to deploy multi-disk clones, this has been improved. It still requires explicit work in pre.d to generate the mapping as an advanced usage scenario.
...
If a collective is one system shy of quorum and a member is deleted to bring quorum back, the leader failed to notify members of restoration of quorum.  This has been addressed.
