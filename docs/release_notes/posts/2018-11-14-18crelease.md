...
## nodeconfig and nodeattrib commands can now accept wildcard expressions
...
If the default policies on the XCC are not desirable, they may be customised as part of discovery.
...
part in a system.  Additionally it will try to resolve generically named adapters to more
descriptive names:
