...
It is recommended to either [use confluent to do PXE discovery and feed the data into xCAT](confluenttoxcat.md) or [use confluent for the OS deployment](../advanced_topics/confluentosdeploy.md).
