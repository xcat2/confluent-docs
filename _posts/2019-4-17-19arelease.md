...
Ability to create and delete volumes and arrays through the XCC.  Examples:
```
$ nodestorage d5 show
...
```
$ nodeattrib d3 discovery.passwordrules=expiration=no,loginfailures=no,reuse=0
d3: expiration=no,loginfailures=no,reuse=0
```
