...
============================
    rpm -ivh https://hpc.lenovo.com/yum/19b/el7/x86_64/lenovo-hpc-yum-1-1.x86_64.rpm
...
============================
    zypper install http://hpc.lenovo.com/yum/19b/suse15/x86_64/lenovo-hpc-zypper-1-1.x86_64.rpm
